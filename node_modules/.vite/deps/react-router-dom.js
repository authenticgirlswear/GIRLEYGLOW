...
var removeDoubleSlashes = /* @__PURE__ */ __name((path) => path.replace(/\/\/+/g, "/"), "removeDoubleSlashes");
...
__name(toRouterStateMatch, "toRouterStateMatch");
...
var TIME_LIMIT_MS = 1;
var getNow = /* @__PURE__ */ __name(() => Date.now(), "getNow");
var yieldToMain = /* @__PURE__ */ __name(() => new Promise((resolve) => setTimeout(resolve, 0)), "yieldToMain");
...
var SingleFetchNoResultError = class extends Error {
  static {
    __name(this, "SingleFetchNoResultError");
  }
};
...
async function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
  try {
    ...
    let result = await staticHandler.query(handlerRequest, {
      ...
      normalizePath: /* @__PURE__ */ __name((r) => getNormalizedPath(r, build.basename, build.future), "normalizePath")
    });
    return handleQueryResult(result);
  } catch (error) {
    return handleQueryError(error);
...
__name(trimTrailingSplat, "trimTrailingSplat");
