import {
  require_jsx_runtime
} from "./chunk-WOSJDAKH.js";
import {
  require_react
} from "./chunk-YHOSSS4F.js";
import {
  __export,
  __name,
  __require,
  __toESM
} from "./chunk-7IARE43G.js";
...
var pipe = /* @__PURE__ */ __name((...transformers) => transformers.reduce((a, b) => (v) => b(a(v))), "pipe");
...
var millisecondsToSeconds = /* @__PURE__ */ __name((milliseconds) => milliseconds / 1e3, "millisecondsToSeconds");

// node_modules/motion-utils/dist/es/velocity-per-second.mjs
var velocityPerSecond = /* @__PURE__ */ __name((velocity, frameDuration) => frameDuration ? velocity * (1e3 / frameDuration) : 0, "velocityPerSecond");
...
var anticipate = /* @__PURE__ */ __name((p) => p >= 1 ? 1 : (p *= 2) < 1 ? 0.5 * backIn(p) : 0.5 * (2 - Math.pow(2, -10 * (p - 1))), "anticipate");
...
__name(containsCSSVariable, "containsCSSVariable");
...
__name(buildTransformer, "buildTransformer");
...
var convertToZero = /* @__PURE__ */ __name((value, splitBefore) => {
...
function spring(optionsOrVisualDuration = springDefaults.visualDuration, bounce = springDefaults.bounce) {
  ...
  if (dampingRatio < 1) {
    ...
    resolveVelocity = /* @__PURE__ */ __name((t) => Math.exp(-undampedAngularFreq * t) * (undampedAngularFreq * C * t - initialVelocity), "resolveVelocity");
  } else {
  ...
  const generator = {
    ...
    velocity: /* @__PURE__ */ __name((t) => secondsToMilliseconds(resolveVelocity(t)), "velocity"),
...
__name(getGeneratorVelocity, "getGeneratorVelocity");
...
var positionalValues = {
  // Dimensions
  width: /* @__PURE__ */ __name(({ x }, { paddingLeft = "0", paddingRight = "0", boxSizing }) => {
    const width = x.max - x.min;
    return boxSizing === "border-box" ? width : width - parseFloat(paddingLeft) - parseFloat(paddingRight);
  }, "width"),
  height: /* @__PURE__ */ __name(({ y }, { paddingTop = "0", paddingBottom = "0", boxSizing }) => {
...
__name(hasBrowserOnlyColors, "hasBrowserOnlyColors");
...
var NativeAnimationWrapper = class extends NativeAnimation {
  static {
    __name(this, "NativeAnimationWrapper");
  }
...
var animationMapKey = /* @__PURE__ */ __name((name, pseudoElement = "") => `${name}:${pseudoElement}`, "animationMapKey");
...
__name(getAnimationMap, "getAnimationMap");
...
__name(calcChildStagger, "calcChildStagger");
...
function animateTarget(visualElement, targetAndTransition, { delay: delay2 = 0, transitionOverride, type } = {}) {
  ...
  if (transitionEnd) {
    const applyTransitionEnd = /* @__PURE__ */ __name(() => frame.update(() => {
...
__name(applyPxDefaults, "applyPxDefaults");
...
__name(createSelectorEffect, "createSelectorEffect");
...
__name(canSetAsProperty, "canSetAsProperty");
var addAttrValue = /* @__PURE__ */ __name((element, state, key, value) => {
...
var addStyleValue = /* @__PURE__ */ __name((element, state, key, value) => {
  let render = void 0;
  let computed = void 0;
...
__name(addSVGPathValue, "addSVGPathValue");
var addSVGValue = /* @__PURE__ */ __name((element, state, key, value) => {
...
__name(convertAttrKey, "convertAttrKey");
...
function hover(elementOrSelector, onHoverStart, options = {}) {
  ...
  elements.forEach((element) => {
    ...
    const removePointerLeave = /* @__PURE__ */ __name(() => {
      element.removeEventListener("pointerleave", onPointerLeave);
    }, "removePointerLeave");
    const endHover = /* @__PURE__ */ __name((event) => {
      if (hoverEndCallback) {
...
__name(isElementTextInput, "isElementTextInput");
...
var observer;
var getSize = /* @__PURE__ */ __name((borderBoxAxis, svgAxis, htmlAxis) => (target, borderBoxSize) => {
...
__name(observeTimeline, "observeTimeline");
...
var msToFps = /* @__PURE__ */ __name((ms) => Math.round(1e3 / ms), "msToFps");
function clearStatsBuffer() {
  statsBuffer.value = null;
  statsBuffer.addProjectionMetrics = null;
}
__name(clearStatsBuffer, "clearStatsBuffer");
...
__name(reportStats, "reportStats");
...
__name(followValue, "followValue");
function attachFollow(value, source, options = {}) {
  ...
  const stopAnimation2 = /* @__PURE__ */ __name(() => {
    if (activeAnimation) {
  ...
  const startAnimation = /* @__PURE__ */ __name(() => {
  ...
  const scheduleAnimation = /* @__PURE__ */ __name(() => {
    startAnimation();
  ...
  value.attach((v, set) => {
    latestValue = v;
    latestSetter = /* @__PURE__ */ __name((latest) => set(parseValue(latest, unit)), "latestSetter");
...
__name(attachFollow, "attachFollow");
...
function subscribeValue(inputValues, outputValue, getLatest) {
  const update = /* @__PURE__ */ __name(() => outputValue.set(getLatest()), "update");
  const scheduleUpdate = /* @__PURE__ */ __name(() => frame.preRender(update, false, true), "scheduleUpdate");
...
__name(subscribeValue, "subscribeValue");
...
__name(transformValue, "transformValue");
...
__name(springValue, "springValue");
function attachSpring(value, source, options) {
  return attachFollow(value, source, { type: "spring", ...options });
}
__name(attachSpring, "attachSpring");
...
__name(chooseLayerType, "chooseLayerType");

// node_modules/motion-dom/dist/es/view/utils/css.mjs
var pendingRules = {};
var style = null;
var css = {
  set: /* @__PURE__ */ __name((selector, values) => {
...
__name(getViewAnimationLayerInfo, "getViewAnimationLayerInfo");
...
__name(filterViewAnimations, "filterViewAnimations");
function getViewAnimations() {
  return document.getAnimations().filter(filterViewAnimations);
}
__name(getViewAnimations, "getViewAnimations");

// node_modules/motion-dom/dist/es/view/utils/has-target.mjs
function hasTarget(target, targets) {
  return targets.has(target) && Object.keys(targets.get(target)).length > 0;
}
__name(hasTarget, "hasTarget");
...
__name(startViewAnimation, "startViewAnimation");
...
var ViewTransitionBuilder = class {
  static {
    __name(this, "ViewTransitionBuilder");
  }
...
__name(animateView, "animateView");
...
__name(setFeatureDefinitions, "setFeatureDefinitions");
function getFeatureDefinitions() {
  return featureDefinitions;
}
__name(getFeatureDefinitions, "getFeatureDefinitions");
...
__name(resolveAxisTranslate, "resolveAxisTranslate");
...
__name(createAnimateFunction, "createAnimateFunction");
...
var asNumber2 = /* @__PURE__ */ __name((value) => typeof value === "string" ? parseFloat(value) : value, "asNumber");
...
__name(delayInSeconds, "delayInSeconds");
...
__name(forceLayoutMeasure, "forceLayoutMeasure");
...
__name(ensureDraggedNodesSnapshotted, "ensureDraggedNodesSnapshotted");
...
var DocumentProjectionNode = createProjectionNode({
  attachResizeListener: /* @__PURE__ */ __name((ref, notify2) => addDomEvent(ref, "resize", notify2), "attachResizeListener"),
...
__name(snapshotFromTarget, "snapshotFromTarget");
var LayoutAnimationBuilder = class {
  static {
    __name(this, "LayoutAnimationBuilder");
  }
...
__name(parseAnimateLayoutArgs, "parseAnimateLayoutArgs");
...
__name(collectLayoutElements, "collectLayoutElements");
...
__name(readLayoutAttributes, "readLayoutAttributes");
...
__name(createVisualState, "createVisualState");
...
__name(getOrCreateRecord, "getOrCreateRecord");
...
__name(findParentRecord, "findParentRecord");
...
__name(getProjectionRoot, "getProjectionRoot");
...
__name(collectAnimations, "collectAnimations");
...
// node_modules/framer-motion/dist/es/components/AnimatePresence/PresenceChild.mjs
var PresenceChild = /* @__PURE__ */ __name(({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  let context = (0, import_react7.useMemo)(() => {
    ...
    return {
      ...
      custom,
      onExitComplete: /* @__PURE__ */ __name((childId) => {
...
// node_modules/framer-motion/dist/es/components/AnimatePresence/index.mjs
var AnimatePresence = /* @__PURE__ */ __name(({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
...
var LayoutGroup = /* @__PURE__ */ __name(({ children, id: id4, inherit = true }) => {
...
__name(initFeatureDefinitions, "initFeatureDefinitions");
function getInitializedFeatureDefinitions() {
  initFeatureDefinitions();
  return getFeatureDefinitions();
}
__name(getInitializedFeatureDefinitions, "getInitializedFeatureDefinitions");
...
function createMotionComponent(Component3, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  __name(MotionDOMComponent, "MotionDOMComponent");
...
function createMotionProxy(preloadedFeatures, createVisualElement) {
  ...
  const factory = /* @__PURE__ */ __name((Component3, options) => {
    return createMotionComponent(Component3, options, preloadedFeatures, createVisualElement);
  }, "factory");
  const deprecatedFactoryFunction = /* @__PURE__ */ __name((Component3, options) => {
    if (true) {
...
var ExitAnimationFeature = class extends Feature {
  static {
    __name(this, "ExitAnimationFeature");
  }
  constructor() {
    super(...arguments);
    this.id = id2++;
...
var addPointerInfo = /* @__PURE__ */ __name((handler) => (event) => isPrimaryPointer(event) && handler(event, extractEventInfo(event)), "addPointerInfo");
...
var getContextWindow = /* @__PURE__ */ __name(({ current: current2 }) => {
...
var VisualElementDragControls = class {
  static {
    __name(this, "VisualElementDragControls");
  }
  ...
  start(originEvent, { snapToCursor = false, distanceThreshold } = {}) {
    ...
    const onSessionEnd = /* @__PURE__ */ __name((event, info) => {
      this.latestPointerEvent = event;
      this.latestPanInfo = info;
    ...
    const resumeAnimation = /* @__PURE__ */ __name(() => {
...
__name(skipFirstCall, "skipFirstCall");
...
__name(startResizeObservers, "startResizeObservers");
...
var MeasureLayoutWithContext = class extends import_react29.Component {
  static {
    __name(this, "MeasureLayoutWithContext");
  }
  /**
...
__name(useMotionValueEvent, "useMotionValueEvent");
...
__name(canUseNativeTimeline, "canUseNativeTimeline");
...
__name(getTargetSize, "getTargetSize");
...
function createOnScrollHandler(element, onScroll, info, options = {}) {
  return {
    ...
    notify: /* @__PURE__ */ __name(() => onScroll(info), "notify")
  };
}
...
var getEventTarget = /* @__PURE__ */ __name((element) => element === document.scrollingElement ? window : element, "getEventTarget");
function scrollInfo(onScroll, { container = document.scrollingElement, trackContentSize = false, ...options } = {}) {
  ...
  if (!scrollListeners.has(container)) {
    const measureAll = /* @__PURE__ */ __name(() => {
      for (const handler of containerHandlers) {
        handler.measure(frameData.timestamp);
      }
      frame.preUpdate(notifyAll2);
    }, "measureAll");
    const notifyAll2 = /* @__PURE__ */ __name(() => {
      for (const handler of containerHandlers) {
        handler.notify();
      }
    }, "notifyAll");
    const listener2 = /* @__PURE__ */ __name(() => frame.read(measureAll), "listener");
  ...
  if (trackContentSize && !dimensionCheckProcesses.has(container)) {
    ...
    const checkScrollDimensions = /* @__PURE__ */ __name(() => {
...
__name(parseStringOffset, "parseStringOffset");
...
__name(normaliseOffset, "normaliseOffset");
...
__name(matchesPreset, "matchesPreset");
...
__name(offsetToViewTimelineRange, "offsetToViewTimelineRange");
...
__name(scrollTimelineFallback, "scrollTimelineFallback");
...
__name(getTimeline, "getTimeline");
...
function attachToAnimation(animation, options) {
  ...
  return animation.attachTimeline({
    ...
    observe: /* @__PURE__ */ __name((valueAnimation) => {
...
__name(attachToAnimation, "attachToAnimation");
...
__name(isElementTracking, "isElementTracking");

// node_modules/framer-motion/dist/es/render/dom/scroll/attach-function.mjs
function isOnScrollWithInfo(onScroll) {
  return onScroll.length === 2;
}
__name(isOnScrollWithInfo, "isOnScrollWithInfo");
...
__name(attachToFunction, "attachToFunction");
...
var isRefPending = /* @__PURE__ */ __name((ref) => {
  if (!ref)
    return false;
  return !ref.current;
}, "isRefPending");
function makeAccelerateConfig(axis, options, container, target) {
  return {
    ...
    factory: /* @__PURE__ */ __name((animation) => {
      let cleanup;
    ...
    times: [0, 1],
    keyframes: [0, 1],
    ease: /* @__PURE__ */ __name((v) => v, "ease"),
    duration: 1
  };
}
__name(makeAccelerateConfig, "makeAccelerateConfig");
...
__name(canAccelerateScroll, "canAccelerateScroll");
function useScroll({ container, target, ...options } = {}) {
  ...
  (0, import_react32.useEffect)(() => {
    if (!needsStart.current)
      return;
    let cleanup;
    const tryStart = /* @__PURE__ */ __name(() => {
...
function useCombineMotionValues(values, combineValues) {
  ...
  updateValue();
  useIsomorphicLayoutEffect(() => {
    const scheduleUpdate = /* @__PURE__ */ __name(() => frame.preRender(updateValue, false, true), "scheduleUpdate");
...
__name(useMapTransform, "useMapTransform");

// node_modules/framer-motion/dist/es/value/use-follow-value.mjs
function useFollowValue(source, options = {}) {
  const { isStatic } = (0, import_react34.useContext)(MotionConfigContext);
  const getFromSource = /* @__PURE__ */ __name(() => isMotionValue(source) ? source.get() : source, "getFromSource");
  if (isStatic) {
...
__name(useFollowValue, "useFollowValue");
...
function useVelocity(value) {
  ...
  const updateVelocity = /* @__PURE__ */ __name(() => {
...
var WillChangeMotionValue = class extends MotionValue {
  static {
    __name(this, "WillChangeMotionValue");
  }
  constructor() {
    super(...arguments);
...
__name(animateElements, "animateElements");

// node_modules/framer-motion/dist/es/animation/animators/waapi/animate-style.mjs
var createScopedWaapiAnimate = /* @__PURE__ */ __name((scope) => {
...
__name(useAnimateMini, "useAnimateMini");
...
__name(usePresenceData, "usePresenceData");
...
__name(disableInstantTransitions, "disableInstantTransitions");
...
function usePageInView() {
  ...
  (0, import_react45.useEffect)(() => {
    const handleVisibilityChange = /* @__PURE__ */ __name(() => setIsInView(!document.hidden), "handleVisibilityChange");
    if (document.hidden) {
...
__name(usePageInView, "usePageInView");
...
__name(transformViewBoxPoint, "transformViewBoxPoint");
...
__name(correctParentTransform, "correctParentTransform");
...
var appearStoreId = /* @__PURE__ */ __name((elementId, valueName) => {
...
__name(handoffOptimizedAppearAnimation, "handoffOptimizedAppearAnimation");
...
__name(resumeSuspendedAnimations, "resumeSuspendedAnimations");
...
__name(startOptimizedAppearAnimation, "startOptimizedAppearAnimation");
...
var StateVisualElement = class extends VisualElement {
  static {
    __name(this, "StateVisualElement");
  }
  constructor() {
    super(...arguments);
    this.measureInstanceViewportBox = createBox;
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const context = {
    axis,
    groupRef,
    registerItem: /* @__PURE__ */ __name((value, layout2) => {
    ...
    updateOrder: /* @__PURE__ */ __name((item, offset, velocity) => {
  ...
  const setRef2 = /* @__PURE__ */ __name((element) => {
...
__name(ReorderGroupComponent, "ReorderGroupComponent");
...
__name(resetAutoScrollState, "resetAutoScrollState");
...
__name(findScrollableAncestor, "findScrollableAncestor");
...
__name(getScrollAmount, "getScrollAmount");
...
__name(autoScrollIfNeeded, "autoScrollIfNeeded");
...
function ReorderItemComponent({ children, style: style2 = {}, value, as = "li", onDrag, onDragEnd, layout: layout2 = true, ...props }, externalRef) {
  ...
  return (0, import_jsx_runtime11.jsx)(Component3, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style2, x: point2.x, y: point2.y, zIndex }, layout: layout2, onDrag: /* @__PURE__ */ __name((event, gesturePoint) => {
  ...
  }, "onDrag"), onDragEnd: /* @__PURE__ */ __name((event, gesturePoint) => {
    resetAutoScrollState();
    onDragEnd && onDragEnd(event, gesturePoint);
  }, "onDragEnd"), onLayoutMeasure: /* @__PURE__ */ __name((measured) => {
    registerItem(value, measured);
  }, "onLayoutMeasure"), ref: externalRef, ignoreStrict: true, children });
}
__name(ReorderItemComponent, "ReorderItemComponent");
