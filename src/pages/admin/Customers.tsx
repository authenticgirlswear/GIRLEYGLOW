/* ===================================================
   AUTHENTIC GIRLSWEAR - Admin Customers
   FIXED:
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-warm-gray text-sm">{customers.length} customers from real orders</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-blush/20 bg-blush-light/20">
                ...
                <th className="text-left py-3 px-4 text-warm-gray font-medium">Contact</th>
                <th className="text-left py-3 px-4 text-warm-gray font-medium">Orders</th>
                <th className="text-left py-3 px-4 text-warm-gray font-medium">Total Spent</th>
                <th className="text-left py-3 px-4 text-warm-gray font-medium">First Order</th>
              </tr>
            </thead>
            <tbody>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="glass-card rounded-xl p-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-warm-gray">{liveSelectedCustomer.email || 'No email'}</p>
                  <p className="text-sm text-warm-gray">{liveSelectedCustomer.phone}</p>
              ...
              <div className="glass-card rounded-xl p-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-warm-gray">
                    ...
                    <span className="text-xs text-warm-gray ml-1">(cancelled excluded)</span>
                  </p>
                  <p className="text-sm text-warm-gray">
            ...
            <div>
              ...
              <div className="space-y-2">
                {liveSelectedCustomer.orders.map((order: RealOrder) => (
                  <div
                    key={order.id}
                    className={`flex items-center gap-3 py-2.5 px-3 rounded-xl border border-blush/10 ${
                      order.status === 'cancelled' ? 'bg-red-50/40 opacity-70' : 'bg-blush-light/20'
                    }`}
                  >
                    ...
                    <span className={`text-sm font-medium flex-shrink-0 ${order.status === 'cancelled' ? 'text-warm-gray line-through' : 'text-charcoal'}`}>
